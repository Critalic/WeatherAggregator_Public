...
import com.example.weatheraggregator.api.security.exception.KeyPairGenerationException;
...
@Service
@PropertySource({"classpath:static/security/token.yml", "classpath:properties/security.properties"})
