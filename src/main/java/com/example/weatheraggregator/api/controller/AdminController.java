...
public class AdminController {
    ...
    @PatchMapping("/provider/trust-coefficient")
    public ResponseEntity<String> setTrustCoefficient(@RequestParam double trustCoefficient,
                                                      @RequestParam @NotEmpty String providerCredential) {
        providerService.setTrustCoefficientForProvider(providerCredential, trustCoefficient);
