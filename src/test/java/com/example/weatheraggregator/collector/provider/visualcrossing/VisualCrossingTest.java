...
class VisualCrossingTest {
    ...
    @Test
    void verifyRequest() {
        VisualCrossing visualCrossing = new VisualCrossing(WebClient.builder(), apiKey, "VisualCrossing");
        ...
        ResponseDTO response = visualCrossing.makeRequest(requestAttributes);
